...
const Explainer = () => {
    return (
        <div className="container">
            ...
            <p>In short, they are links that are automatically populated and updated with information that a compoter can read. These files are in the format called XML.</p>
